...
public class YandexSDK : MonoBehaviour
{
    ...
    public event Action<bool> DeviceInfoSuccess;    //События
    ...
    public void GettingDeviceInfo()    // Получение данных
    {
        GetDeviceInfo();
    }
    ...
    public void DeviceInfoReady(string type)    // Авторизация успешно пройдена
    {
        Debug.Log("Устройство: " + type);
        if (type == "desktop")
            DeviceInfoSuccess?.Invoke(false);
        else
            DeviceInfoSuccess?.Invoke(true);
    }
}
